...
final class WebViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // robokassa_sdk: upstream looked the loader up in
        // `Bundle(identifier: "org.cocoapods.RobokassaSDK")`, a bundle id that only
        // exists while the SDK is its own pod. Vendored into the Flutter plugin it
        // returns nil and the loader silently vanishes, so resolve the bundle that
        // actually ships this class instead.
        #if SWIFT_PACKAGE
